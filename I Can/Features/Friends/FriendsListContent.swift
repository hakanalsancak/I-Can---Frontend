...
struct FriendsListContent: View {
    ...
    let onSelectProfile: (AthleteProfile) -> Void
            ...
            if viewModel.pendingRequests.isEmpty {
                ...
                ForEach(viewModel.pendingRequests) { request in
                    FriendRequestCard(
                        ...
                        onSelectProfile(request.sender)
                    }
                    .padding(.horizontal, 20)
                }
            }
            ...
            if viewModel.sentRequests.isEmpty {
                ...
                ForEach(viewModel.sentRequests) { request in
                    SentRequestCard(
                        ...
                        onSelectProfile(request.receiver)
                    }
                    .padding(.horizontal, 20)
                }
            }
...
fileprivate struct SearchResultCard: View {
...
fileprivate struct FriendRequestCard: View {
...
fileprivate struct SentRequestCard: View {
...
fileprivate struct FriendCard: View {
...
fileprivate struct FriendCardButtonStyle: ButtonStyle {
